document.addEventListener('DOMContentLoaded', function() {
    ...
    function defineMovieConstants(movie, mediaType, apiKey) {
        ...
        return { imgUrl, trailerUrl, rating, detailsUrl };
    }
...
//                    carouselDiv.classList.add('container-wrap'); 
        ...
        fetch(upcomingUrl)
            ...
            .then(upcomingData => {
                ...
                wrapMovies.forEach(movie => {
                    ...
                    const { imgUrl, trailerUrl, detailsUrl } = defineMovieConstants(movie, 'movie', apiKey);
